/* @meta
{
  "name": "zhihu/following",
  "description": "Get Zhihu following feed (关注动态)",
  "domain": "www.zhihu.com",
  "args": {
    "limit": {"required": false, "description": "Number of posts to fetch (default: 10)"}
  },
  "readOnly": true,
  "example": "bb-browser site zhihu/following 20"
}
*/
async function(args) {
  const limit = args.limit || 10;
  const resp = await fetch(`/api/v3/moments?limit=${limit}&desktop=true`, {
    credentials: 'include',
    headers: {
